# El programa viene desde el ejercicio Section18_156_to_158_Detecting_Moving....q
...
while True:
    ...
    motion_status_list = motion_status_list [-2:]                                                           # Unicamente nos quedamos con los dos últimos valores
...
df.to_csv("moving_Detection_Times.csv")
